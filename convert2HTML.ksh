	...
	do
		...
		echo "<head>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
		echo "<link rel=\"stylesheet\" href=\"../../css/report.css\"/>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
		echo "</head>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
		echo "<body>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
		reportName=`echo $report | cut -d. -f1 | sed 's/\([a-z]\)\([A-Z]\)/\1 \2/g' | tr '[a-z]' '[A-Z]'`
		echo "<h2>$reportName</h2>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
		echo "<p>`date '+%a %d-%b-%Y %R'`</p>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
		...
		case $report in 
			...
			do
				...
				echo "<td>$date</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$remote_mgmt</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$os</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$kernel</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$model</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$cpu</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$zonetype</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
			...
			do
				...
				echo "<td>$date</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$os</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$netbackup</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$rsync</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$uptime</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "</tr>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
			done < $REPORT_DIR/$report
			;;
			...
			do
				...
				echo "<td>$date</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "<td>$zonelist</td>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
				echo "</tr>" >> $REPORT_DIR/`echo $report | cut -d. -f1`.html
			done < $REPORT_DIR/$report
			;;	
		esac
